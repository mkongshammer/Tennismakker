      ...
      <form action={action} className="card mt-6 space-y-5">
        ...
        <div className="border-t border-slate/10 pt-5">
          ...
          <div className="space-y-2">
            <label className="flex cursor-pointer gap-3 rounded-md border border-slate/15 p-3">
              ...
              <span>
                ...
                <span className="block text-sm text-slate/60">
        ...
        <button className="btn-court w-full">Opret klub</button>
