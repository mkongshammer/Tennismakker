...
const T: Dict = {
  ...
  "home.trustPriceBody": {
    da: "Ingen gebyrer oveni ved kassen. Det, der står, er det, du betaler.",
    en: "No fees added at checkout. What it says is what you pay.",
    de: "Keine Gebühren an der Kasse. Was dasteht, zahlst du.",
    sv: "Inga avgifter på köpet i kassan. Det som står är det du betalar.",
    no: "Ingen gebyrer på toppen i kassen. Det som står, er det du betaler.",
  },
  "home.trustCancel": {
    da: "Aflys og få pengene igen",
    en: "Cancel and get your money back",
    de: "Absagen und Geld zurück",
    sv: "Avboka och få pengarna tillbaka",
    no: "Avlys og få pengene igjen",
  },
  "home.trustCancelBody": {
    da: "Aflyser du i god tid før spilletid, betaler vi tilbage automatisk.",
    en: "Cancel in good time before the slot and we refund automatically.",
    de: "Sagst du rechtzeitig ab, erstatten wir automatisch.",
    sv: "Avbokar du i god tid före speltid betalar vi tillbaka automatiskt.",
    no: "Avlyser du i god tid før spilletid, betaler vi tilbake automatisk.",
  },
  "home.ctaSignup": {
